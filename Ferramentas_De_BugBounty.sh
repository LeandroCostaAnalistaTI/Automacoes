...
eval wget -nc -O ~/Lists/XSS-OFJAAAH.txt https://raw.githubusercontent
                                                                     t.com/danielmiessler/SecLists/master/Fuzzing/XSS/XSS-OFJAAAH.txt
eval wget -nc -O ~/Lists/params.txt https://raw.githubusercontent.com/
                                                                     /s0md3v/Arjun/master/arjun/db/params.txt
eval wget -nc -O ~/.gf/potential.json https://raw.githubusercontent.co
                                                                     om/devanshbatham/ParamSpider/master/gf_profiles/potential.json
...
go install github.com/projectdiscovery/shuffledns/cmd/shuffledns@lates
                                                                     st
sleep 1
...
go install github.com/projectdiscovery/subfinder/v2/cmd/subfinder@late
                                                                     est
sleep 1
...
go install github.com/projectdiscovery/interactsh/cmd/interactsh-clien
                                                                     nt@latest
Sleep 1
